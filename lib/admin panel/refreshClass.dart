...
class _DayMondayState extends State<DayMonday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
}
...
class _DayTuesdayState extends State<DayTuesday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
...
class _DayWednesdayState extends State<DayWednesday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
...
class _DayThursdayState extends State<DayThursday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
...
class _DayFridayState extends State<DayFriday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
...
class _DaySaturdayState extends State<DaySaturday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
...
class _DaySundayState extends State<DaySunday> {
  @override
  Widget build(BuildContext context) {
    return BuildClassesForRoutineManager();
  }
